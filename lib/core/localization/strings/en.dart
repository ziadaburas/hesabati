...
const Map<String, String> enStrings = {
  // App
  'app_name': 'Qitaa Ledger',
  'app_subtitle': 'Advanced Accounting System',
  ...
  'use_local': 'Use Locally',
  'use_local_desc': 'Use the app without login',
  ...
  'local_accounts': 'My Local Accounts',
  'shared_accounts': 'Shared Accounts',
  'create_shared_account': 'Create Shared Account',
  'no_accounts': 'No accounts',
  'add_first_account': 'Start by adding your first account',
  ...
  'enter_description': 'Please enter transaction description',
  'enter_username': 'Please enter username',
  'select_user': 'Please select a user first',
};
